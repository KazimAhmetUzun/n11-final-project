...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleProductNotFound(
        ...
        log.warn("Product not found. path={}, message={}", request.getRequestURI(), exception.getMessage());
    ...
    public ErrorResponse handleInsufficientStockException(InsufficientStockException exception, HttpServletRequest request) {
